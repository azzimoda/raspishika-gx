...
• Ежедневная рассылка: можно подключить несколько групп и получать их расписания на неделю в одно время. Откройте /settings → «Группы для рассылки»
• Команды /today, /tomorrow, /week, напоминания перед парами и уведомления об изменениях используют основную группу
